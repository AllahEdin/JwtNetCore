...
Создать контекст
Scaffold-DbContext "User ID=test;Password=test;Host=localhost;Port=7777;Database=db_test_1;Pooling=true;" Npgsql.EntityFrameworkCore.PostgreSQL -OutputDir Models -context MigrationPostgreSqlContext -Schema places,aspnet -Project JwtWebApi.MigrationProvider -force -NoPluralize
